...
serve(async (req) => {
  ...
  try {
    ...
    const systemPrompt = `You are Mantlet, an AI assistant specialized in stablecoins. You have comprehensive knowledge of all major stablecoins including USDT, USDC, DAI, and others. Provide helpful, accurate information about stablecoins when asked.`;
